...
IMPORTANT: Do NOT include romanizations (like "naeil" or "mollayo") in your explanation. Only use Korean characters and English translations.`;
  ...
  return (
    <div className="sentence-box">
      ...
      />
      <TranslationDisplay
        translation={blankPhrase.translation || ''}
        highlightEnglishWords={highlightEnglishWords}
        englishWordIndices={englishWordIndices}
        textSize={textSize}
      ...
      <PracticeControls
        ...
        setShowAnswerBelow={setShowAnswerBelow}
        showExplanation={showExplanation}
        handleToggleExplanation={handleToggleExplanation}
      ...
      <ExplanationBox
        ...
        currentPhrase={currentPhrase}
        blankPhrase={blankPhrase}
        getFullKoreanSentence={getFullKoreanSentence}
        mdToHtml={mdToHtml}
      />
      <VariationIndicator
        usingVariations={usingVariations}
      ...
      <ProgressPanel
        ...
        verbPracticeSession={verbPracticeSession}
        ...
        setShowSetDialog={setShowSetDialog}
        progressPercentage={progressPercentage}
        numBlanks={numBlanks}
        setNumBlanks={setNumBlanks}
